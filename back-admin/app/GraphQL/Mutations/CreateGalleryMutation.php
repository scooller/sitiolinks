...
class CreateGalleryMutation extends Mutation
{
    ...
    public function resolve($root, array $args)
    {
        ...
        if (! $user->hasAnyRole($allowedRoles)) {
            throw new \Rebing\GraphQL\Error\AuthorizationError('No tienes permisos para crear galerías. Solo administradores y creadores pueden crear galerías.');
        }
    ...
    protected function checkGalleryLimit($user): void
    {
        ...
        throw new \Rebing\GraphQL\Error\AuthorizationError('No tienes permisos para crear galerías.');
    }
}
