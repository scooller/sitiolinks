        ...
        return $table
            ...
            ->filters([
                SelectFilter::make('collection_name')
                    ->options(
                        fn () => \Spatie\MediaLibrary\MediaCollections\Models\Media::query()
                                ...
                                try {
                                    ...
                                    if (str_starts_with($media->mime_type, 'image/')) {
                                        ...
                                        if (file_exists($originalPath)) {
                                            \App\Support\WatermarkManipulator::apply($originalPath);
                                        }
                                        ...
                                        foreach ($media->getGeneratedConversions() as $conversionName => $generated) {
                                            if ($generated) {
                                                ...
                                                if (file_exists($conversionPath)) {
                                                    \App\Support\WatermarkManipulator::apply($conversionPath);
                                                }
                                            }
                                        }
                                    ...
                                    \Illuminate\Support\Facades\Log::error('Error regenerando media: '.$e->getMessage());
                                }
                            }
